  ...
  _.shuffle([
    {
      ...
      story_index: 1,
      n_hormones: 2,
      condition: "you had observed A to be absent",
      consequent: "A be present"
    },
    {
      story_name: 'story1',
      story_index: 1,
  ...
  _.shuffle([
    {
      ...
      story_index: 2,
      n_hormones: 3,
      condition: "you had observed B to be absent",
      consequent: "A be present"
    },
    {
      story_name: 'story2',
  ...
  _.shuffle([
    {
      ...
      story_index: 6,
      n_hormones: 3,
      condition: "you had observed B to be present",
      consequent: "A be present"
    },
    {
      story_name: 'story6',
  ...
  slides.trial = slide({
    ...
    present_handle : function(stim) {
      if (!this.just_beginning) {
        ...
        $(".prompt").html("");
        $(".prompt").html(write_prompt(condition, consequent, rat_name));

        this.init_sliders();
        exp.sliderPost = null; //erase current slider value
        exp.yes_no = null
        $(":radio[name=response]").attr("checked", false);
      }
    },
    ...
    button : function() {
      if (_s.just_beginning) {
        ...
        exp.yes_no = $(":radio[name=response]:checked").val();
        if (exp.sliderPost == null | exp.yes_no == null) {
          $(".err").show();
        } else {
          this.log_responses();
          $(".answers").hide();
    ...
    log_responses : function() {
      ...
      exp.data_trials.push({
        ...
        "condition": _s.stim.condition,
        "consequent": _s.stim.consequent,
        "response": exp.yes_no,
