	...
	var counterfactuallyIfNot = cache(function(args) {
		...
		return Infer(
			...
			function() {
				...
				var statesData = statesModel(latents);
				var states = statesData[0];
				var actualERP = statesData[1];
				...
				var cfStatesData = statesModel(cfLatents, actualERP);
				var cfStates = cfStatesData[0];
