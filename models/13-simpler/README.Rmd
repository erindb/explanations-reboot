...
Here's what happens when we marginalize over `causal_strength`, `parent_prior_prob`, and `effect_background_prior_prob` (with a uniform prior). It's very similar. **this takes 4 minutes to run** 
