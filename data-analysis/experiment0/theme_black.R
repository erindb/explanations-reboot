...
theme_black = function(base_size = 12, base_family = "") {
  ...
  theme_grey(base_size = base_size, base_family = base_family) %+replace%
    ...
    theme(
      ...
      axis.text.x = element_text(size = base_size*0.8, color = "darkgray", lineheight = 0.9),  
      axis.text.y = element_text(size = base_size*0.8, color = "darkgray", lineheight = 0.9),  
      ...
      legend.key = element_blank(),#element_rect(color = "white",  fill = "black"),  
